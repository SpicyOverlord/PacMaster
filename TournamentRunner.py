    ...
    def startNewTournament(agentClass: type[IAgent], populationSize: int, generationCount: int,
        ...
        population = [
            WeightContainer({'fleeThreshold': 7.60937, 'pelletLevelDistance': 0.10431, 'tooCloseThreshold': 86.32886,
                             ...
                             'ghostIsCloserMultiplier': 0.46973, 'edgeMultiplier': 0.17925,
                             'pelletLevelDistanceInDangerLevel': 212.96985, 'pelletsInDangerLevelMultiplier': 0.11793,
                             'distanceToPacManMultiplier': 0.16287, 'PelletIslandDistance': 0.11847,
                             'IslandSizeMultiplier': 0.00949, 'IslandDistanceMultiplier': 45.60294,
                             'ghostMultiplier': 0.11594, 'blinky': 0.09273, 'pinky': 1142.2821, 'inky': 0.02258,
                             'clyde': 0.27173}),
            WeightContainer({'fleeThreshold': 7.56977, 'pelletLevelDistance': 0.07855, 'tooCloseThreshold': 223.7031,
                             ...
                             'clyde': 0.26981}),
            WeightContainer({'fleeThreshold': 10.3649, 'pelletLevelDistance': 171.04447, 'tooCloseThreshold': 0.55431,
            ...
            WeightContainer({'fleeThreshold': 5.44416, 'pelletLevelDistance': 65.626, 'tooCloseThreshold': 227.15288,
            ...
            WeightContainer({'fleeThreshold': 10.50887, 'pelletLevelDistance': 258.61358, 'tooCloseThreshold': 17.88223,
                             'tooCloseValue': 3694.69894, 'tooFarAwayThreshold': 0.0233,
                             'dangerZoneMultiplier': 0.06301, 'dangerZoneMiddleMapNodeMultiplier': 0.8647,
                             'ghostIsCloserMultiplier': 1.09873, 'edgeMultiplier': 0.01347,
                             'pelletLevelDistanceInDangerLevel': 3.44943, 'pelletsInDangerLevelMultiplier': 1.34617,
                             ...
                             'ghostMultiplier': 4.08185, 'blinky': 0.01855, 'pinky': 0.01967, 'inky': 1.26083,
                             'clyde': 1.53354}),
            WeightContainer({'fleeThreshold': 0.00463, 'pelletLevelDistance': 520.37405, 'tooCloseThreshold': 66.61675,
                             ...
                             'clyde': 44.10417}),
            WeightContainer({'fleeThreshold': 0.20279, 'pelletLevelDistance': 12.96206, 'tooCloseThreshold': 0.0029,
            ...
            WeightContainer({'fleeThreshold': 0.64834, 'pelletLevelDistance': 6.80099, 'tooCloseThreshold': 1.65777,
                             'tooCloseValue': 374.82911, 'tooFarAwayThreshold': 0.2217, 'dangerZoneMultiplier': 0.00551,
                             'dangerZoneMiddleMapNodeMultiplier': 0.01326, 'ghostIsCloserMultiplier': 0.00387,
                             'edgeMultiplier': 2.96274, 'pelletLevelDistanceInDangerLevel': 1434.80925,
                             'pelletsInDangerLevelMultiplier': 0.02618, 'distanceToPacManMultiplier': 0.10388,
                             'PelletIslandDistance': 17.12896, 'IslandSizeMultiplier': 1.80522,
