...
if __name__ == "__main__":
    ...
    stats = calculatePerformanceOverXGames(
        ...
        decayRate=0.995,  # The rate at which the alpha and rho values will decay.
        ...
        gameSpeed=0.3,  # Sets the speed of the game from 0.1 (slow) to 15 (fast).
        startLevel=1,  # Choose the starting level for the agent (0 for level one, 1 for level two, and so on).
