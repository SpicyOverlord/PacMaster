    ...
    while True:
        ...
        if game.gameOver:
            ...
            if gameStats.levelsCompleted >= 2:
                ...
                save_snapshots_to_file(agent.snapshots, "Over2Q10LivesLearning")
            return gameStats
...
def calculateRewardFunctionPerformanceOverXGames(agentClass: type[IAgent], weightContainer: WeightContainer = None,
                                                 gameCount: int = 50, gameSpeed=1, startLevel: int = 0, startLives=1,
                                                 ghostsEnabled: bool = True, freightEnabled: bool = True,
                                                 logging=False, lockDeltaTime=False,
                                                 disableVisuals: bool = False):
    ...
    for gameStat in gameStats:
        yesCount += gameStat.agent.yes
        noCount += gameStat.agent.no

    performance['combinedScore'] = round(yesCount / noCount, 5)
